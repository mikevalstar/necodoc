---
type: reference
title: Open Knowledge Format (OKF) 0.2 specification
description: Verbatim local copy of the OKF 0.2 spec that this docs/ bundle follows.
tags: [tooling, process]
status: stable
source: https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md
retrieved: 2026-08-08
generated: { by: process:snapshot, at: 2026-08-08T00:00:00Z }
---

> **External copy.** This is a verbatim snapshot of the upstream OKF 0.2 spec
> (frontmatter added locally). Do not edit; re-fetch from the source to update.
